...
namespace API.Controllers
{
    ...
    {        
        ...
        public async Task<ActionResult<Product>> CreateProduct(ProductCreateDto productToCreate)
        {
            ...
            if (result <= 0) return BadRequest(new ApiResponse(400, "Creating product failed!"));
        ...
        public async Task<ActionResult<Product>> UpdateProduct(int id, ProductCreateDto productToUpdate)
        {
            ...
            if (result <= 0) return BadRequest(new ApiResponse(400, "Updating product failed!"));
        ...
        public async Task<ActionResult> DeleteProduct(int id)
        {
            ...
            if (result <= 0) return BadRequest(new ApiResponse(400, "Deleting product failed!"));
